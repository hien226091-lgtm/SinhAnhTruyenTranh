...
- Phải yêu cầu chính xác 2 bóng thoại trống:
  + 1 bóng thoại lớn ở góc trên bên trái.
  + 1 bóng thoại lớn ở góc trên bên phải.
  + Cả hai đều màu trắng, viền đen dày, để trống hoàn toàn.
  + Không để nền hoặc nhân vật chồng vào bên trong 2 bóng thoại.
